...
plot_sim_summary(summary_exceedance, xlab = "# included seasons", ylab = "exceedance proportion", ylim = 0:1)
...
plot_sim_summary(summary_exceedance1, xlab = "# included seasons", ylab = "exceedance proportion", ylim = 0:1)
...
plot_exceedane_summary(summary_exceedance1_nolog_fr, xlab = "# included seasons", ylab = "exceedance proportion")
